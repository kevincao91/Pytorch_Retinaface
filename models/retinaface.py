...
class RetinaFace(nn.Module):
    def __init__(self, cfg=None, phase='train'):
        ...
        self.ClassHead = self._make_class_head(fpn_num=3, inchannels=cfg['out_channel'], anchor_num=3)
        self.BboxHead = self._make_bbox_head(fpn_num=3, inchannels=cfg['out_channel'], anchor_num=3)
        self.LandmarkHead = self._make_landmark_head(fpn_num=3, inchannels=cfg['out_channel'], anchor_num=3)
